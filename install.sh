...
tampilan() {
    ...
    allowed_ips_url="https://raw.githubusercontent.com/Ghalihx/project/main/ip"
...
echo ""
clear
REPO="https://raw.githubusercontent.com/Ghalihx/project/main/"
start=$(date +%s)
secs_to_human() {
...
memasang_notifikasi_bot() {
  ...
  local izinsc="https://raw.githubusercontent.com/Ghalihx/project/main/ip"
...
"
  ...
  local INLINE_KEYBOARD='{"inline_keyboard":[[{"text":"Telegram","url":"https://t.me/GallVpnStore"},{"text":"Contact","url":"https://wa.me/6283834366608"}]]}'
